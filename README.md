...
The final model (Model 12, with interaction terms) explains 93.7% of resale price variance. Key finding: number-linked superstitions have a measurable effect on HDB prices, and the effect has grown roughly sevenfold since the early 1990s.
...
| 14 | Revised final model (Model 11/12, drop failed variables) |
...
- **Block-4 penalty:** Flats in blocks containing the digit 4 sell for about $10,000 less (town FE) or $1,400 less (street-level FE). The penalty has grown 25-fold since 1990.
- **Trailing-8 premium:** Each trailing 8 in the price adds about $1,700 (Model 12). Survives every robustness check including median regression and outlier removal.
- **888 prevalence:** 0.02% of transactions ended in 888 in 1990–91. By 2024–25, 8.4% did.
- **168 anchor:** 24 flats priced at exactly $1,168,000–$1,168,888 all sold above predicted value, by $147,000 on average. Only significant in the >$800K segment.
